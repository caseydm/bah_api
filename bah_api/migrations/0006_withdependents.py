...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bah_api', '0005_delete_withdependents'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('O8', models.DecimalField(decimal_places=2, max_digits=10)),
                ('O9', models.DecimalField(decimal_places=2, max_digits=10)),
                ('O10', models.DecimalField(decimal_places=2, max_digits=10)),
            ],
        ),
    ]
